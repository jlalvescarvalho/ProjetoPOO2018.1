...
public interface IFachadaFuncionario {
    ...
    void cadastrarCliente(String nome, String cpf, String rua, String bairro, String cep, String numero, String cidade) throws CPFApenasNumerosException, CPFTamanhoException, NomeInvalidoException, ClienteJaExiteException, CampoEnderecoVazioException, CepInvalidoException;
    ...
    void cadastrarVendaComCliente(Funcionario funcionario, Cliente cliente, double desconto) throws VendaVaziaException;
    void cadastrarVendaSemCliente(Funcionario funcionario) throws VendaVaziaException;
